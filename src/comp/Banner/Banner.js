                        ...
                        <div className='left'>
                            ...
                            <div>
                                <Button className='py-2 px-3 resume rounded-pill'>
                                    <a href='https://drive.google.com/uc?id=1Zz8opBk23BolJ-U_0z2IqhyLQVeIIBMl&export=download' style={{color: 'white'}} className='fs-6 fw-bold text-decoration-none '>Download Resume <FontAwesomeIcon className='icon d-icon ms-2 fa-twitter' style={{color: 'white'}} icon={faDownload}/></a>
                                </Button>
                            </div>
                            <div className='ani'>
