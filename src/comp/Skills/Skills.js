      ...
      <Container>
        <div className="py-5 position-relative d-flex justify-content-center align-items-center">
          <h2
            ...
            className="text-24 opacity-4 text-uppercase fw-600 w-100 mb-0 text-center"
          >
            Skills
          </h2>
          <h2
            style={{ fontSize: "50px" }}
            className="position-absolute  skill-after mb-0"
          >
            What I Khow
          </h2>
        </div>
        <Row>
          ...
          <Col sm={12} md={6} lg={6}>
            <p className="mt-2 fw-bold fs-5">
              Bootstrap <span className="float-end">85%</span>
            </p>
            <ProgressBar now={85} />
            <p className="mt-2 fw-bold fs-5">
              Metarial UI <span className="float-end">90%</span>
            </p>
            <ProgressBar now={90} />
            <p className="mt-2 fw-bold fs-5">
            ...
            <ProgressBar now={85} />
            <p className="mt-2 fw-bold fs-5">
              HTML5 <span className="float-end">90%</span>
            </p>
            <ProgressBar now={90} />
            <p className="mt-2 fw-bold fs-5">
